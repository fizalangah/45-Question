...
let famous_person:string = "Willium Shakespear";
let message:string ="once william Shakespear said,To be or not to be,that is the question.";
...
// QUESTION # 10
     //friend data
  let friendName:string = "my best friend name is ayesha and she is my classmate"
     //  my data
let myName2:string = "my name is fiza and i m an IT student"

// QUESTION # 11;
let names1:string[] = ["ayesha","rabia","kanwal","shabana","aliya"]
console.log(names1);

//  QUESTION # 12;

let names:string[] = ["ayesha","rabia","kanwal","shabana","aliya"]
...
let cars:string[]= ["hoda","civic","alto","cultus","rivo"]
...
let guest1:string[]= ["hira","amina","sohana"];
...
let guest2:string[]= ["hira","amina","sohana"];
 ...
 console.log(guest2[2],"I like to invite you for a dinner plz come my home at 9pm");
  let newguest1:string = guest2[2] = "shabana";
  console.log(newguest1);
  console.log(guest2);
  
// QUESTION # 16;

let guest3:string[]= ["hira","amina","sohana"];
 ...
 let newguest2:string = guest3[2] = "shabana";
...
// QUESTION # 17;
 ...
 let guest:string[]= ["hira","amina","sohana"];
 console.log(guest[0],"I like to invite you for a dinner plz come my home at 9pm"); 
  ...
  let newguest:string = guest[2] = "shabana";
...
//QUESTION # 18;
 ...
 let countries:string[ ] = ["dubai","pakistan","UAE","maldeevs","america" ]
 console.log(countries.sort());
 console.log(countries.reverse())
 let newcountries:string[] = ["america","maldeevs","UAE","pakistan","dubai"]
...
let cities:string[]= ["karachi","multan","lahore","islamabad","hyderabab"];
console.log(cities);

//QUESTION # 21;

type pentype = {"name":string,"color":string,"price":number,"isUdesd":boolean};
...
let rollNumbers:number[] = [10,11,12,13,14,15,16]
console.log(rollNumbers);
...
let myName3:string = "fiza langah";
...
let myName4:string = "fiza langah"
console.log( myName4 == "fiza langah");
      // LOWER CASE;
 let cname:string = "fiza";
...
//QUESTION # 26;
 ...
 if(alien_color2 == "green"){ console.log("player just earned 5 points");
 }
 else{
...
let favourit_fruits:string[] =  ["apple","banana","mango","lichi","lichi" ,"painapple"];
...
// QUESTION # 30;
 ...
 let userNames1:string[] = [ "admoin", "fiza","kanwal","ali","bilawal"];
...
// QUESTION # 32;
 ...
 let current_users:string[] = ["hurain","husnain","mehak","zulkernain","daood",];

 let new_users:string[] = ["hurain","husnain", "saleem", "shazia","sidra"];
...
let oridnal_numbers:string[] = ["1st", "2nd","3rd","4th","5th","6th","7th","8th","9th"];
...
//QUESTION # 34;
 ...
 let pizzas:string[] = ["cheesiPizza", "chickenPizza","pepperoniPizza"];
...
let animals:string[] = ["Dog","Cat","hourse"];
...
let make_shirt2 = ((size:string)=>{
 console.log("i love typscript")
     })
     make_shirt2("large");
let make_shirt3 = ((size:string)=>{
     console.log(" i love typscript")
     })
 make_shirt3("medium");

let make_shirt = ((size:string)=>{
...
let describe_cities =((country:string)=>{
...
let magicianc_name:string[] = ["dai vernon","harry","david","doug henning"];
